...
class billClass:
    def __init__(self,root):
        ...
        self.product_Table["columns"] = [col[0] for col in table_columns]
        self.product_Table["show"] = "headings"

        for col_id, text, width in table_columns:
            self.product_Table.heading(col_id, text=text)
            self.product_Table.column(col_id, width=width)
        ...
        self.CartTable["columns"] = [col[0] for col in cart_table_columns]
        self.CartTable["show"] = "headings"

        for col_id, text, width in cart_table_columns:
            self.CartTable.heading(col_id, text=text)
            self.CartTable.column(col_id, width=width)

        self.CartTable.pack(fill=BOTH,expand=1)
        self.CartTable.bind("<ButtonRelease-1>",self.get_data_cart)


        #-------------- Widgets for adding to cart ---------------
        ...
        product_quantity_text_area = Entry(
            Add_CartWidgets_Frame,
